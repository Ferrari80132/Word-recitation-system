...
### v1.0.5 (2026-09-21)
- ✨ **选择题答案显示优化**
- ✨ 第一轮和第二轮选择题在选择答案后，显示所有选项的对应释义
- ✨ 第一轮（英文选中文）：显示每个中文释义对应的英文单词
- ✨ 第二轮（中文选英文）：显示每个英文单词对应的中文释义
- ✨ 答案显示时间从 1 秒延长到 2 秒，方便用户学习
- 🎨 添加 `.option-supplement` CSS 类，可自定义答案释义的字体样式
- 💡 帮助用户更好地区分易混淆单词，加强记忆效果
